# = Define wpt::htpasswd
#
# This define managed wpt htpasswd files
# Based on CamptoCamp Apache module:
# https://github.com/camptocamp/puppet-wpt/blob/master/manifests/auth/htpasswd.pp
#
# == Parameters
#
# [*ensure*]
...
#   Default: "${wpt::params::config_dir}/htpasswd"
#
# [*crypt_password*]
...
define wpt::htpasswd (
  ...
  $real_htpasswd_file = $htpasswd_file ? {
    ''      => "${wpt::params::config_dir}/htpasswd",
